...
class Arrow(GObject.GObject):
    ...
    def on_drag_follow(self, gesture, end_x, end_y):
        ...
        self.draw_arrow(start_x_char, start_y_char, width, height, False)
    ...
    def on_drag_end(self, gesture, delta_x, delta_y):
        ...
        if height < 0:
            ...
            height += 1
        self.draw_arrow(start_x_char, start_y_char, width, height, True)
    ...
    def draw_arrow(self, start_x_char, start_y_char, width, height, draw):
